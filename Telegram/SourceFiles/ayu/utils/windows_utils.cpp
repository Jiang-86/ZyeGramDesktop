...
void processLegacy(const QString &iconPath) {
	...
	auto shortcut = appdata + "/Microsoft/Internet Explorer/Quick Launch/User Pinned/TaskBar/ZyeGram Desktop.lnk";
	if (!QFile::exists(shortcut)) {
		shortcut = appdata + "/Microsoft/Internet Explorer/Quick Launch/User Pinned/TaskBar/ZyeGram.lnk";
	}
	if (!QFile::exists(shortcut)) {
...
void processNewShortcuts(const QString &iconPath) {
	...
	const auto shortcuts = {
		path + u"ZyeGram Desktop/ZyeGram.lnk"_q,
		path + u"ZyeGram/ZyeGram.lnk"_q,
